---
id: incident-response-error-detective
tier: optional
label: "Error Detective"
summary: "Analyzes error traces, logs, and observability data to identify error signatures, reproduction steps, user impact, and timeline context for production issues."
