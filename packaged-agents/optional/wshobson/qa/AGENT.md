...
tier: optional
label: "Qa"
summary: "QA Agent. Tests all acceptance criteria and edge cases from orchestrator-output.md. Generates a structured qa-report.md with pass/fail per criterion and bug triage. Loops back to implement if bugs found (max 2 iterations)."
domain: "ship-mate"
skillSlugs: []
---
