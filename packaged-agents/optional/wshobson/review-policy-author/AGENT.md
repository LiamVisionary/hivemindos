...
tier: optional
label: "Review Policy Author"
summary: "Cedar policy author specialized in gating AI agent review actions (PR comments, reviews, merges, CI edits) behind human approval. Use when writing, auditing, or extending a review-governance.cedar policy for review-bot governance."
domain: "review-agent-governance"
skillSlugs: []
---
