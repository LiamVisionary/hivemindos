...
| skills            | Already bundled with HivemindOS; do not run a skills installer                                                                                                                                                                                                                                                                        |
...
- text-effects.md — 24 named text animation effects (per-character, per-word, per-line, whole) — vocabulary reference for the separate `pixel-point/animate-text` skill (use it only when the separately installed `/animate-text` skill is already available). Specs live in that upstream skill, not in this repo.
