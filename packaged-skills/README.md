...
- `gtm/hivemindos/linkedin-gtm`: optional HivemindOS GTM skill for a three-layer LinkedIn motion — content and authority (hook shapes, four content types, profile optimization), warming before outreach, and outreach (connection requests, a 4-message DM sequence, sell-by-chat, inbox triage) — with human approval on all outbound and explicit LinkedIn-terms caution on automation.
- `gtm/hivemindos/organic-reach-gtm`: optional HivemindOS GTM skill for an organic content-to-pipeline engine — 3-pillar weekly mix, five post-type skeletons, lead-magnet posts with comment-keyword CTAs, a 3-person content team on a Friday-ready cycle, signature-framework + proof-library positioning, a 4-channel distribution flywheel, and Instagram as B2B top-of-funnel — with a hard no-fabricated-proof rule.
