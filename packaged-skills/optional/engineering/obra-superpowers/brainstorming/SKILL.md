---
name: brainstorming
description: Use for materially ambiguous, novel, cross-system, or costly-to-reverse engineering work that benefits from a reviewed design before implementation; keep clear reversible tasks lightweight.
license: MIT
---
...
6. **Write design doc** — use the project's established spec location and do not commit unless authorized
...
- Write the validated design to the project's established spec location
...
> "Spec written to `<path>` (uncommitted unless separately authorized). Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
