...
description: Use when an approved implementation plan has independent tasks and the active HivemindOS runtime permits delegated implementer and reviewer roles.
license: MIT
---
