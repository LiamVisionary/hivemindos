---
name: writing-plans
description: Use when a material multi-step engineering design needs an executable plan in the project's established planning surface.
license: MIT
---
...
Expected: FAIL with "target_behavior not defined"

- [ ] **Step 3: Write minimal implementation**

```python
def target_behavior(input):
    return expected
```
