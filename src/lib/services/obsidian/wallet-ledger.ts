...
function parseRecordMarkdown(filename: string, content: string): WalletLedgerRecord | null {
  ...
  const wallet: AgentWalletConfig = {
    ...
    tradingVenue: (fm.tradingVenue === "alpaca" || fm.tradingVenue === "robinhood-agentic" || fm.tradingVenue === "xstocks" || fm.tradingVenue === "robinhood-chain") ? fm.tradingVenue : undefined,
