  ...
  return [
    ...
    },
    {
      ...
      retrievalText: [
        ...
        "MiroShark buyer path: POST /api/miroshark/x402 with action 'run' to pay the public MiroShark x402 endpoint, using exactly one of prompt, url, or article plus optional deep_research, prediction_market, and affiliate. Use action 'suggest' for free ideas, 'status' with runId, and 'report' with runId and format 'json' or 'md'.",
    ...
    },
    {
      ...
      retrievalText: [
        "Use POST /api/miroshark/x402 when a user asks to run a MiroShark social simulation over x402, get MiroShark launch ideas, check a run, or retrieve a report.",
