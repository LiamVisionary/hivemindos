...
export const HIVE_COMPUTE_WORKER_VERSION = "0.3.0";
...
export const HIVE_COMPUTE_WORKLOAD_MANIFEST_ENV = "HIVE_COMPUTE_WORKLOAD_MANIFEST_JSON";
export const HIVE_COMPUTE_CONFIDENTIAL_SIDECAR_URL_ENV = "HIVE_COMPUTE_CONFIDENTIAL_SIDECAR_URL";
export const HIVE_COMPUTE_CONFIDENTIAL_SIDECAR_TOKEN_ENV = "HIVE_COMPUTE_CONFIDENTIAL_SIDECAR_TOKEN";
export const HIVE_COMPUTE_CONFIDENTIAL_SIDECAR_SIGNING_PUBLIC_KEY_ENV = "HIVE_COMPUTE_CONFIDENTIAL_SIDECAR_SIGNING_PUBLIC_KEY";
export const HIVE_COMPUTE_SELF_HOSTED_ALLOW_NONCONFIDENTIAL_ENV = "HIVE_COMPUTE_SELF_HOSTED_ALLOW_NONCONFIDENTIAL";
