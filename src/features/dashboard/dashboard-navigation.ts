...
const DASHBOARD_ROUTE_CATALOG_BY_ID = {
  ...
  trade: { label: "Trade", detail: "Buy, sell, and swap crypto & stocks", group: "Primary", keywords: ["trade", "trading", "buy", "sell", "swap", "stock", "stocks", "shares", "crypto", "perps", "options", "polymarket", "bridge", "xstocks", "alpaca"], shelfGroup: 0 },
  ...
  integrations: { label: "Integrations", detail: "Nango and external APIs", group: "Utilities", keywords: ["integrations", "nango", "api", "apps"], shelfGroup: 2 },
  ...
  notifications: { label: "Alerts", detail: "Agent notifications", group: "Utilities", keywords: ["alerts", "notifications", "inbox"] },
