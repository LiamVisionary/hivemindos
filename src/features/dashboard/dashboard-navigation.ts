...
export const DASHBOARD_ROUTE_CATALOG: DashboardRouteCatalogItem[] = [
  ...
  { id: "trade", label: "Trade", detail: "Buy, sell, and swap crypto & stocks", group: "Primary", keywords: ["trade", "trading", "buy", "sell", "swap", "stock", "stocks", "shares", "crypto", "perps", "options", "polymarket", "bridge", "xstocks", "alpaca"] },
  { id: "governance", label: "Zero Human Company", detail: "Companies, budgets, spend approvals", group: "Utilities", keywords: ["zero human company", "zhc", "governance", "company", "companies", "budget", "approval", "approvals", "kill switch", "spend"] },
  ...
  { id: "messaging", label: "Messaging", detail: "Agent messaging channels", group: "Utilities", keywords: ["messaging", "telegram", "discord", "imessage", "channels", "alerts"] },
