import { Activity, AppWindow, Bell, Bot, BrainCircuit, Cpu, FolderOpen, KanbanSquare, KeyRound, Layers3, MessageSquare, Network, PhoneCall, PlugZap, Repeat2, Search, ShieldCheck, WalletCards, Wrench } from "lucide-react";
