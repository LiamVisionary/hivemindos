...
export function useAgentController(props: UseAgentControllerProps) {
  ...
  async function createAgentFromModal() {
    ...
    const draft: AgentProfile = {
      ...
      a2aUrl: undefined,
      gatewayUrl: autopilotRuntime ? "" : agentCreateDraft.gatewayUrl || baseAgent.gatewayUrl,
      chatPath: autopilotRuntime ? "" : agentCreateDraft.chatPath || baseAgent.chatPath,
      statusPath: autopilotRuntime ? "" : agentCreateDraft.statusPath || baseAgent.statusPath,
