...
export default function DashboardApp({ initialChatAgentId, initialChatLeaf, initialView, initialVaultPanelMode, initialWorkHistory }: DashboardAppProps = {}) {
  ...
  return (
    ...
    <>
      ...
      {activeView === "governance" ? <GovernancePanel theme={dashboardTheme === "hive-light" ? "light" : "dark"} openSkillAttachmentBrowser={openSkillAttachmentBrowser} /> : null}
