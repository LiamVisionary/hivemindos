...
const AeonAutopilotPanel = dynamic(() => import("@/features/dashboard/views/AeonAutopilotPanel").then((mod) => mod.AeonAutopilotPanel), { ssr: false });
