...
The buyback rule is enforced by HivemindOS-controlled infrastructure across supported revenue streams. Confirmed purchases are published in the [HIVE Buyback Ledger](https://hivemindos.app/buybacks/). Pending allocations, failed batches, projected capacity, and unconfirmed transactions do not count as HIVE bought. HivemindOS does not burn HIVE.
