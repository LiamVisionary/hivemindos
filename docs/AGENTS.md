...
- Whole-brain docs live under `docs/for-users/whole-brain/`. Keep them synchronized with setup initializers, vault doctor behavior, shared skills, and `scripts/test-vault-structure-contract.mjs`.
