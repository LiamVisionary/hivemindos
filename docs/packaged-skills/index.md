...
The optional media catalog includes HivemindOS-authored growth and analysis helpers, such as `media/hivemindos/instagram-reel-growth-workflow` for account-specific Reels workflows and `media/hivemindos/video-shot-transcript` for local shot/angle breakdowns with transcript or visible-caption alignment.
