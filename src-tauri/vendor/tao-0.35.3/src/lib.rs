...
// HivemindOS patch: this crate is vendored (with the macOS `sendEvent:`
// override removed in `platform_impl/macos/app.rs`); quiet upstream
// dependency warnings so they do not flood Tauri dev builds.
