...
// HivemindOS patch: this is a vendored copy (see [patch.crates-io] in
// src-tauri/Cargo.toml) carrying a macOS startup fix in
// platform_impl/macos/app.rs. Path dependencies surface all upstream
// warnings during Tauri dev builds; silence them so dev output stays usable.
#![allow(warnings)]
