    ...
    tauri_build::try_build(
        tauri_build::Attributes::new().app_manifest(
            tauri_build::AppManifest::new().commands(&[
                "desktop_status",
                "native_pairing_host",
                "beeline_local_credentials_list",
                "beeline_local_credential_store",
                "beeline_local_credential_delete",
                "beeline_local_credentials_delete_profile",
                ...
                "brain_graph",
                "read_local_brain_drop_documents",
                "hive_env_read",
                "fleet_apps_cache",
                "fleet_discover",
                "tailscale_devices",
