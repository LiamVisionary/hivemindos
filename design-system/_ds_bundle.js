...
function Segmented({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    const activeBg = variant === "solid" ? tone === "sell" ? "var(--danger)" : "var(--honey)" : "var(--honey-soft)";
